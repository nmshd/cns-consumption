    ...
    public run(): void {
        ...
        describe("ProposeAttributeRequestItemProcessor", function () {
            ...
            describe("canCreateOutgoingRequestItem", function () {
                ...
                it("value type in attribute value and query must be the same", function () {
                    const recipientAddress = CoreAddress.from("recipientAddress")
                ...
                it("cannot mix IdentityAttribute and RelationshipAttributeQuery", function () {
                    const recipientAddress = CoreAddress.from("recipientAddress")
                ...
                it("cannot mix RelationshipAttribute and IdentityAttributeQuery", function () {
                    const recipientAddress = CoreAddress.from("recipientAddress")
